# -*-coding:utf-8-*-
from flog4p.logger import Logger, Constant
...
def help():
    ...
    print '打印用例：不带参数,带参数'
    print 'logger.info("test format logs")'
    print 'logger.info("test format logs first params is {},sencond  params is {}", "one",222)'
